...
<body>
    <div class="cert-outer">
        <div class="cert-inner">
            ...
            <div class="meta-info">
                Instruktur: <span><?php echo e($course->instructor ? $course->instructor->name : 'Instruktur Resmi'); ?></span> 
                &nbsp; | &nbsp; 
                Total Waktu Belajar: <span><?php echo e($totalMinutes); ?> Menit</span> 
                &nbsp; | &nbsp; 
                Status: <span>LULUS</span>
            </div>
            
            <div class="date">
                Diterbitkan pada tanggal <?php echo e(\Carbon\Carbon::parse($certificate->issued_at)->translatedFormat('d F Y')); ?>
            ...
            <div class="cert-code">ID Sertifikat: <?php echo e($certificate->certificate_code); ?> | Validasi di Amania Platform</div>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\laragon\www\amania-backend\resources\views/pdf/certificate.blade.php ENDPATH**/ ?>